...
def check_backup_status(**context):
    ...
    backup_dir = "/home/bookchaowalit/book/book_docker/backups/complete"
...
pre_backup_check = BashOperator(
    ...
    AVAILABLE=$(df /home/bookchaowalit/book/book_docker/backups --output=avail | tail -1)
...
upload_to_remote = BashOperator(
    ...
    if [ -n "$BACKUP_FILE" ]; then
        mkdir -p /home/bookchaowalit/book/book_docker/backups/remote
        cp "$BACKUP_FILE" /home/bookchaowalit/book/book_docker/backups/remote/
...
cleanup_old_backups = BashOperator(
    ...
    find /home/bookchaowalit/book/book_docker/backups/complete -name "*.tar.gz" -mtime +30 -delete
    find /home/bookchaowalit/book/book_docker/backups/remote -name "*.tar.gz" -mtime +90 -delete 2>/dev/null || true
...
send_failure_email = EmailOperator(
    ...
    <p><strong>Check the Airflow logs for details.</strong></p>

    <h3>Recommended Actions:</h3>
    <ul>
        <li>Check if Vault is running: <code>docker ps | grep vault</code></li>
        <li>Check disk space: <code>df -h</code></li>
        <li>Check backup logs: <code>/home/bookchaowalit/book/book_docker/backups/complete/*/logs/backup.log</code></li>
